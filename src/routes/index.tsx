            ...
            <section className="relative py-20 px-6 text-center overflow-hidden">
                ...
                <div className="relative max-w-5xl mx-auto">
                    ...
                    <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-8">
                        Create groups, organize events, manage wishlists, and
                        assign gifts to group members. Never forget a gift
                        again!
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300">
                        ...
                        <p className="text-gray-400 leading-relaxed">
                            Organize your gift planning by creating groups with
                    ...
                    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300">
                        ...
                        <p className="text-gray-400 leading-relaxed">
                            Create events for birthdays, holidays, or any
                            special occasion that needs gift planning.
                        </p>
                    </div>
                    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300">
                        <h3 className="text-xl font-semibold text-white mb-3">
                        ...
                        <p className="text-gray-400 leading-relaxed">
                            Assign gifts to group members and track purchase
