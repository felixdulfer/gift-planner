		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>Add a gift to this wishlist</DialogDescription>
				</DialogHeader>
				<form
					onSubmit={(e) => {
						e.preventDefault();
				...
				>
					<div className="grid gap-4 py-4">
						<form.Field
							...
							validators={{
								onChange: ({ value }) =>
									!value ? "Gift name is required" : undefined,
							}}
						>
							{(field) => (
								<div className="grid gap-2">
									<Label htmlFor={field.name}>Gift Name</Label>
									<Input
										id={field.name}
						...
						<form.Field name="picture">
							{(field) => (
								<div className="grid gap-2">
									<Label htmlFor={field.name}>Picture URL (optional)</Label>
									<Input
										id={field.name}
										type="url"
										value={field.state.value}
